...
| 4.9 | ENG-001 reference model: 4.9a–e complete; 4.9f partial — 4/7 diagrams produced, semantically corrected, fully connected, rendered to SVG (new: phase-b-activity-sprint-v1, phase-c-class-er-v1; updated: phase-b-archimate-business-v1 v0.4.0); ACO-001/AIA-001 collaboration+interaction entities added; 115 connection files; 4.9g–h pending | Partial |
