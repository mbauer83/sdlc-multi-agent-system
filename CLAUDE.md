...
| 4.9 | ENG-001 reference model: 4.9a–f complete (core 7/7 + additional workflow-net activity views); scope-based diagram naming normalization and re-render complete; 4.9g (overview docs + ADRs) pending | Partial |
